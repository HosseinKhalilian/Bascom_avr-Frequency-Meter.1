...
### This repository is Digital Frequency Meter with manual range selection.
Frequency of a periodic signal is the number of cycles it repeats per second!. So If we count the number of cycles recorded in a second it will directly read the frequency.This circuit counts the input frequency and display it on the LCD and S1-S2 keys are placed to determine the frequency range in Hz-KHz.
...
<p align="center">
<a href="./LICENSE.md">
<img alt="GitHub license" src="https://img.shields.io/github/license/khalilian-ah/Bascom_avr-Frequency-Meter.1?style=badge">
</a>
